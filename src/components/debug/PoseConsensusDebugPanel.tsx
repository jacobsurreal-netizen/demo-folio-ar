...
function renderSnapshot(
  ...
  lines.push(
    ...
    '— gate candidate (recent 14) —',
    `gateWindowSampleCount: ${diagnostics.gateWindowSampleCount}`,
    `gateWindowAgeMs: ${Math.round(diagnostics.gateWindowAgeMs)}`,
    `gateScreenStability: ${formatMetric(diagnostics.gateScreenStability, 3)}`,
    `gateNormalStability: ${formatMetric(diagnostics.gateNormalStability, 3)}`,
    `gateDepthStability: ${formatMetric(diagnostics.gateDepthStability, 3)}`,
    `gateViewpointQualityAvg: ${formatMetric(diagnostics.gateViewpointQualityAvg, 3)}`,
    `gateViewpointQualityMin: ${formatMetric(diagnostics.gateViewpointQualityMin, 3)}`,
    `gateConsensusProgress: ${formatMetric(diagnostics.gateConsensusProgress, 3)}`,
