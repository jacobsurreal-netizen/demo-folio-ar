...
function renderSnapshot(
  ...
  lines.push(
    ...
    `positionSpread: ${formatMetric(diagnostics.positionSpread, 3)}`,
    `positionSpreadMax: ${formatMetric(diagnostics.positionSpreadMax, 3)}`,
    ...
    '— normalized —',
    `positionStability: ${formatMetric(diagnostics.positionStability, 3)}`,
